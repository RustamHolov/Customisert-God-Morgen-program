public class Greeting{
    ...
    public string GetHoroscope(DateTime birthDate) => $"You were born: {birthDate:d} and your zodiac sing is {GetZodiac(birthDate)}. A lot of happiness awaits you this month.";
